...
- `visual-hive handoff-validate`: validates the Evidence Packet and Hive handoff artifacts before trusted workflow consumption, including no-network policy, sanitization, artifact consistency, Hive readiness mode policy, blocked full automation, and guarded-repair restrictions.
