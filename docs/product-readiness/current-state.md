...
- Product `CI` passed on `main` run `28910330503` for commit `df8e119f`.
- Product `Product Proof` passed on `main` run `28910330506` for commit `df8e119f`, including the blocked-by-default GitHub App live-smoke proof and the issue-agent readiness path.
...
- Demo-site `Visual Hive Production Smoke` passed on `main` run `28909087970` for commit `cdbe762` while checking out current Visual Hive `main` after product commit `1747a70e`, including the GitHub App artifact-ingestion smoke after consolidating to the single trusted publisher workflow.
- Demo-site `Visual Hive Trusted Publisher` passed on `main` run `28909217640` for the production-smoke artifacts from commit `cdbe762`.
