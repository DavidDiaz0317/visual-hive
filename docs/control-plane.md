...
- Run Profiles for curated local workflows such as PR acceptance, triage refresh, mutation adequacy audit, and coverage improvement generation. Profiles are built from server-generated runbook command IDs, not browser-provided shell text.
