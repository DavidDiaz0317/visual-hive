...
- Run Profiles for curated local workflows such as PR acceptance, canary health planning, full PR-safe planning, triage refresh, mutation adequacy audit, coverage improvement generation, provider governance review, and portfolio refresh. Profiles are built from server-generated runbook command IDs, not browser-provided shell text.
