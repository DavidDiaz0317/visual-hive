...
```bash
gh attestation verify visual-hive-0.4.0.tar.gz --repo DavidDiaz0317/visual-hive
sha256sum --check visual-hive-0.4.0.tar.gz.sha256
tar -xzf visual-hive-0.4.0.tar.gz
node visual-hive-0.4.0/visual-hive.mjs --version
```
