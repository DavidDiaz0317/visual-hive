...
const latestPlan = await readOptionalJson(".visual-hive/plan.json");
const latestReport = await readOptionalJson(".visual-hive/report.json");
...
if (latestPlan?.outputResource) checkOutputResource(latestPlan.outputResource, "Latest plan outputResource", artifactIndex);
if (latestReport?.outputResource) checkOutputResource(latestReport.outputResource, "Latest report outputResource", artifactIndex);
